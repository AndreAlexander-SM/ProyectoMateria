            ...
            return (
                <View style={styles.container}>
                    ...
                    <View style={styles.header}>
                        <TouchableOpacity style={styles.headerBtn} onPress={() => setScreen('apartados')}>
                    ...
                    <View style={styles.card}>
                        ...
                        <Text style={styles.label}>¿Cual es el nombre de este apartado?</Text>
                        <TextInput
                            style={styles.input}
                        ...
                        <TextInput style={styles.cantidad} placeholder='$0.00' keyboardType='number-pad'  textAlign='center'></TextInput>

                        <TouchableOpacity style={styles.totalBtn}>
                            <Text style={styles.totalBtnText}>Total disponible</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.apartarBtn} onPress={() => setScreen('confirmar')}>
