...
export default function Editar({ onNext }) {
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholder="Monto Nuevo" style={styles.input} keyboardType="numeric" />
      ...
      <View style={styles.row}>
        <TouchableOpacity style={[styles.boton, styles.cancel]}>
          <Text style={[styles.textoBoton, { color: "#000000ff" }]}>Actualizar</Text>
        </TouchableOpacity>

        <TouchableOpacity style={[styles.boton, styles.delete]} onPress={onNext}>
          <Text style={[styles.textoBoton, {color: "#ffffffff" }]}>Eliminar</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
